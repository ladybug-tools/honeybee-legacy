...
Provided by Honeybee 0.0.57
    ...
    Args:
        ...
        _filmCoefficient: A numerical value in W/m2-K (or SI U-Values) that represents the conductivity of the air film at the boundary condition.  Typical values range from 26 W/m2-K (for an NFRC exterior envelope) to 2.5 W/m2-K (for an interior wood/vinyl surface).
