...
Provided by Ladybug 0.0.62
    ...
    Args:
        ...
        _scheduleName: An optional name for the schedule that will be written to the memory of the document.  If no name is connected here, a uniqui ID will be generated for the schedule.
        ...
        generateValues_: Set to "True" to generate hourly values of the schedule.
...
if initCheck == True and writeSchedule_ == True:
    result = main(_sun, _mon, _tue, _wed, _thu, _fri, _sat, holiday_, heatDesignDay_, coolDesignDay_, generateValues_, epwFileForHol_, startDayOfWeek_, customHolidays_, _scheduleName, _schedTypeLimits_)
    if result != -1:
        schedule, holidays, scheduleValues, schedIDFText, weekSchedule = result
        print 'schedule written to memory!!'
        if generateValues_ == True:
