...
Use this component to create your own horizontial axis wind turbine to use in Energyplus simulations. This component simulates wind turbines by using the simple Power Calculation method - which means that the Maximum Power coefficient must be calculated.
...
ghenv.Component.Name = "Honeybee_Generator_Wind_Simple_Horizontialaxis"
ghenv.Component.NickName = 'Generator:Wind:Simple:Horizontialaxis'
...
def checktheinputs(name_,powercontrol,rotor_speed,rotor_diameter,overall_height,power_output,rated_wind_speed,cut_in_windspeed,cut_out_windspeed,overall_turbine_n,max_tip_speed_ratio,max_power_coefficient,local_av_windspeed,height_local_metrological_station,turbine_cost):
...
def main(name_,powercontrol,rotor_speed,rotor_diameter,overall_height,number_of_blades,power_output,rated_wind_speed,cut_in_windspeed,cut_out_windspeed,overall_turbine_n,max_tip_speed_ratio,max_power_coefficient,local_av_windspeed,height_local_metrological_station,turbine_cost):
    ...
    print " The Maximum Power Coefficient for the turbine is "+ str(max_power_coefficient)
...
if checktheinputs_template(template_medium_turbine,template_large_turbine) != -1:
...
if checktheinputs(name_,powercontrol,rotor_speed,rotor_diameter,overall_height,power_output,rated_wind_speed,cut_in_windspeed,cut_out_windspeed,overall_turbine_n,max_tip_speed_ratio,max_power_coefficient,local_av_windspeed,height_local_metrological_station,turbine_cost) != -1:
    
    HB_windturbine = main(name_,powercontrol,rotor_speed,rotor_diameter,overall_height,number_of_blades,power_output,rated_wind_speed,cut_in_windspeed,cut_out_windspeed,overall_turbine_n,max_tip_speed_ratio,max_power_coefficient,local_av_windspeed,height_local_metrological_station,turbine_cost)
