...
Provided by Honeybee 0.0.65
    ...
    Args:
        _HBZones: HBZones for which you want to change schedules.
        occupancySchedules_: A text string representing the occupancy schedule that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.
        occupancyActivitySchs_: A text string representing the schedule for the metabolic rate of the occupants that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component. If this is a custon schedule, the values in it should be Watts and the "units_" or "_schedTypeLimits_" input should be "ActivityLevel."
        heatingSetPtSchedules_: A text string representing the heating setpoint schedule that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.  If this is a custon schedule, the values in it should be Watts and the "units_" or "_schedTypeLimits_" input should be "Temperature."
        coolingSetPtSchedules_: A text string representing the cooling setpoint schedule that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.  If this is a custon schedule, the values in it should be Watts and the "units_" or "_schedTypeLimits_" input should be "Temperature."
        lightingSchedules_: A text string representing the lighting schedule that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.
        equipmentSchedules_: A text string representing the equipment schedule that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.
        infiltrationSchedules_: A text string representing the infiltration schedule that you want to use.  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.
        ventilationSchedules_: A text string representing the ventilation schedule that you want to use.  Note that this schedule overrides the typical ventilation that occurs based on the occupancy schedule and the "ventilationPerPerson."  The ventilation will be hard-sized based on this schedule and the maximum combined flowrates of "ventilationPerPerson" and "ventilationPerarea."  This can be either a schedule from the "Honeybee_Call from EP Schedule Library" component, a schedule from the "Honeybee_Annual Schedule" component, or a CSV schedule from the "Honeybee_Create CSV Schedule" component.
    Returns:
        schedules: A report of what schedules are assigned to each zone.
        HBZones: HBZones that have had thier schedules modified.
"""
