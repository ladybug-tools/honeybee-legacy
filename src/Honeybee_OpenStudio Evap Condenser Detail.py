...
Provided by Honeybee 0.0.55
    ...
    Args:
        ...
        _serviceType : what does the evaporator serve: single speed DX, two speed DX, VRF, or commercial refrigeration system
        _evaporativeEffectiveness_:... supply nothing and it defaults 
        ...
        _hiSpeedEvaporativeEffectiveness_:... only needed for two-speed condenser,supply nothing and it defaults 
...
ghenv.Component.Name = "Honeybee_OpenStudio Evap Condenser Detail"
...
def main():
    ...
    if _evaporativeEffectiveness_ != None:
        if _evaporativeEffectiveness_ <0 or _evaporativeEffectiveness_ > 1:
    ...
    if _serviceType == 0:
        if _hiSpeedEvaporativeEffectiveness_ != None:
            print 'your hi Speed Evaporative Effectiveness is Ignored'
            w = gh.GH_RuntimeMessageLevel.Remark
            ghenv.Component.AddRuntimeMessage(w, "You have selected a one speed Evaporative condenser.  All hi speed definitions are ignored.")
        if _hiSpeedEvaporativeCondAirflowRate_ != None:
            print 'your hi Speed Evap Condenser Airflow Rate is Ignored'
            w = gh.GH_RuntimeMessageLevel.Remark
            ghenv.Component.AddRuntimeMessage(w, "You have selected a one speed Evaporative condenser.  All hi speed definitions are ignored.")
        if _hiSpeedEvapPumpPower_ != None:
