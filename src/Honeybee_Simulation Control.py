...
Provided by Honeybee 0.0.66
    ...
    Args:
        ...
        minWarmupDays_: The minimum number of warmup days that you want the energyplus simulation to run before recording result values.  The default is set to 6.
    Returns:
