...
def checkTheInputs():
    ...
    if windowShadeStatus_.BranchCount == 1:
        ...
        checkData14, checkData32, winStatusUnits, winStatusHeaders, winStatusNumbers, analysisPeriod = checkCreateDataTree(windowShadeStatus_, "windowShadeStatus_", "Surface Shading Device Is On Time Fraction")
